...
<template>
     <div id="app" class="flex container h-screen w-full">
          <div class="lg:w-1/5 border-r border-lighter px-2 lg:px-6 py-2 flex flex-col justify-between">
               <div>
                    ...
                    <div>
                         <button v-for="tab in tabs" @click="id = tab.id"
                              :class="`focus:outline-none hover:text-blue flex items-center py-2 px-4 hover:bg-lightblue rounded-full mr-auto mb-3 ${id === tab.id ? 'text-blue-500' : ''}`">
               ...
               <div class="lg:w-full relative">
                    <button @click="dropdown = true"
                         ...
                         <img src="profile.jpg" class="w-10 object-cover h-10 rounded-full border border-lighter" />
                         <div class="hidden lg:block ml-4">
                              <p class="text-sm font-bold leading-tight"> Taupik Otto </p>
                              <p class="text-sm leading-tight"> @ottoismail </p>
                         </div>
                    ...
                    <div v-if="dropdown === true"
                         ...
                         <button @click="dropdown = false"
                              ...
                              <img src="profile.jpg"
                                   class="w-10 object-cover h-10 rounded-full border border-lighter" />
                              <div class="ml-4">
                                   <p class="text-sm font-bold leading-tight"> Taupik Otto </p>
                                   <p class="text-sm leading-tight"> @ottoismail </p>
                              </div>
          ...
          <div class="w-full md:w-1/2 h-full overflow-y-scroll">
               ...
               <div class="px-5 py-3 border-b-4 border-lighter flex">
                    <div class="flex-none">
                         <img src="profile.jpg"
                              class="flex-none object-cover w-12 h-12 rounded-full border border-lighter" />
                    </div>
                    <form v-on:submit.prevent="addNewTweet" class="w-full px-4 relative">
                         <textarea v-model="tweet.content" placeholder="What's up?"
                              class="mt-3 pb-3 w-full focus:outline-none"></textarea>
                         ...
                         <button type="submit"
                              class="h-7 px-3 text-white font-semibold bg-blue-500 hover:bg-darkblue focus:outline-none rounded-full absolute bottom-0 right-0">
                              Tweet
                         </button>
                    </form>
               </div>
               <div class="flex flex-col-reverse">
                    <div v-for="tweet in tweets" class="w-full p-4 border-b hover:bg-lighter flex">
                         <div class="flex-none mr-4">
                              <img src="profile.jpg" class="h-12 object-cover w-12 rounded-full flex-none" />
                         </div>
                         <div class="w-full">
                              <div class="flex items-center w-full">
                                   <p class="font-semibold"> Taupik Otto </p>
                                   <p class="text-sm text-dark ml-2"> @ottoismail </p>
               ...
               <div v-for="follow in following" class="w-full p-4 border-b hover:bg-lighter flex">
                    <div class="flex-none mr-4">
                         <img :src="`${follow.src}`" class="h-12 w-12 object-cover rounded-full flex-none" />
                    </div>
                    <div class="w-full">
                         <div class="flex items-center w-full">
          ...
          <div class="md:block hidden w-1/3 h-full border-l border-lighter py-2 px-6 overflow-y-scroll relative">
               ...
               <div class="w-full rounded-lg bg-lightest my-4">
                    ...
                    <button v-for="friend in friends" class="w-full flex hover:bg-lighter p-3 border-t border-lighter">
                         <img :src="`${friend.src}`" class="w-12 h-12 object-cover rounded-full border border-lighter" />
                         <div class="hidden lg:block ml-4">
     ...
     data() {
          return {
               ...
               trending: [
                    ...
                    { top: 'Music', title: 'Blackpink', bottom: '135K Tweets' },
                    { top: 'Pop', title: 'Blackpink', bottom: '40k tweets' },
                    { top: 'Trending in Sport', title: 'Ac Milan', bottom: '40k tweets' },
                    { top: 'Trending', title: 'Blackpink', bottom: '25.4k tweets' },
               ],
               friends: [
                    { src: 'elon.jpg', name: 'Elon Musk', handle: '@teslaBoy' },
                    { src: 'yandi.jpeg', name: 'Yandi Ar', handle: '@yandiAr' }
               ],
               following: [
                    { src: 'elon.jpg', name: 'Elon Musk', handle: '@teslaBoy', time: '20 min', tweet: 'buying twitter is not a difficult thing for me', comments: '1,000', retweets: '550', like: '1,000,003' },
                    { src: 'yandi.jpeg', name: 'Yandi Ar', handle: '@yandiAr', time: '30 min', tweet: 'Awesome !', comments: '100', retweets: '50', like: '999' },
               ],
               tweet: { content: '' }
          }
     },
